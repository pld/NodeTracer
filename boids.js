...
function addLetters(el) {
    ...
    function lettersToSpans(textEl) {
        $(textEl.parentNode).replaceText(/(B)/g, "<span class='letter' onclick='var event = arguments[0];event.stopPropagation(); off = $(this).offset();$(this).attr(\"ox\", off.left);$(this).attr(\"oy\", off.top);'>$1</span>");
    }
...
$(document).ready(function() {
    ...
    $('.letter').live('mouseover', function() {
